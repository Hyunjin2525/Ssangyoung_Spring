...
<body>
 	<div class="row row1">
 		...
 		<form method="post" action="../databoard/update_ok.do"><!-- 파일 업로드 프로토콜 -->
 		<table class="table">
 			<tr>
 			...
 			<tr>
 				...
 				<td width="85%"><input type=text name=subject size=50 value="${vo.subject }"></td>
 			</tr>
 			<tr>
 			...
 			<tr>
 				...
 				<td width="85%"><input type=password name=pwd size=10></td>
 			</tr>
 			<tr>
