						...
						<table class="table">
							<tr>
								<td width=30% class="text-center" rowspan="4">
									...
									<img src="${vo.poster }" style="width: 290px;height: 160px;" class="img-round">
									</a>
								</td>
								<td width=70%>
								<h3><a href="../food/food_before_detail.do?fno=${vo.fno }">
									${vo.name }&nbsp;</a><span style="color:orange">${vo.score }</span></h3>
								</td>
							</tr>
							<tr>
