...
public interface GoodsMapper {
	@Select("SELECT no,goods_name as name,goods_poster as poster,goods_price as price,num "
			...
			+ "FROM (SELECT no,goods_name,goods_poster,goods_price FROM goods_all ORDER BY no ASC)) "
	...
	public void goodsHit(int no);
	@Select("SELECT no,goods_name as name,goods_sub as sub,goods_poster as poster,goods_price as price,goods_discount as discount,"
