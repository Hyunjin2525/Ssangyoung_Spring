...
public class BoardController {
	...
	public String board_reply(int pno,Model model)
	{
		...
		model.addAttribute("pno",pno); //root번호
		model.addAttribute("main_jsp","../board/reply.jsp");
		return "main/main";
	}
	
	@PostMapping("reply_ok")
	public String board_reply_insert(int pno,BoardVO vo)
	{
	...
	@PostMapping(value = "update_ok.do",produces = "text/html;charset=UTF-8") //한글깨짐 방지
	@ResponseBody
