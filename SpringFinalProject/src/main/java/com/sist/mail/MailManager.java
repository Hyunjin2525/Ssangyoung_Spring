...
public class MailManager {
	...
	public void naverMailSend(Object obj,int type) {
		...
		if(type==1)
	     ...
	     String user = "tktmzpt7@naver.com"; // 패스워드 
	     String password = "hyun0205";      // SMTP 서버 정보를 설정한다. 
	     Properties props = new Properties(); 
	     props.put("mail.smtp.host", host); 
	     props.put("mail.smtp.port", 587); 
	     props.put("mail.smtp.auth", "true");   //네이버 메일 셋팅
	     ...
	     try { 
	        	MimeMessage message = new MimeMessage(session); 
	              ...
	              message.addRecipient(Message.RecipientType.TO, new InternetAddress("tktmzpt7@naver.com")); // 메일 제목 //받는 사람
