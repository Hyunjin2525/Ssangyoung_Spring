...
<body>
	<div class="container">
		...
		<div class="row">
			<input type=text ref="fd" class="input-sm" size=25 placeholder="검색어 입력" id="keyword" v-on:keyup="selectMusic()">
		</div>
		<div style="height: 20px;"></div>
		<div class="row">
			...
			mounted:function(){
				...
				//$(function(){===mounted===})
				  $('#keyword').keyup(function(){
					...
					let temp=$('#user-table > tbody > tr > td:nth-child(4n+3):contains("'+k+'")'); //4n = 컬럼 수
					$(temp).parent().show();
				})  
			},
			methods:{
